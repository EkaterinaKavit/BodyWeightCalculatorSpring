...
public class BodyWeightRepository implements BodyWeightInterface{
    ...
    @Override
    public ResponseIndex save(double weight, double height, double index, LocalDateTime date){
        Long id = idGenerator.getAndIncrement();
        ResponseIndex dataOfPerson = new ResponseIndex(id,weight, height, index,date);
